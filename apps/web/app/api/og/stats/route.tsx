...
import { DUB_LOGO, nFormatter, truncate } from "@u0/utils";
...
export async function GET(req: NextRequest) {
  ...
  const domain = req.nextUrl.searchParams.get("domain") || "u0.wtf";
    ...
    (
      <div
        style={{
          ...
          backgroundImage: `url(https://u0.wtf/_static/background.png)`,
        }}
      >
        <img
          src={DUB_LOGO}
