...
/* 
  ...
  1. Project link page, e.g. app.u0.wtf/dub/u0.wtf/github
  2. Generic U0.wtf link page, e.g. app.u0.wtf/links/steven
  3. Public stats page, e.g. u0.wtf/stats/github, stey.me/stats/weathergpt
...
export default function Stats({
  ...
  const { basePath, domain, baseApiPath } = useMemo(() => {
    // Project link analytics page, e.g. app.u0.wtf/dub/analytics?domain=u0.wtf&key=github
    if (slug) {
      return {
      ...
      // Generic links analytics page, e.g. app.u0.wtf/analytics?domain=u0.wtf&key=github
    ...
    // Public stats page, e.g. u0.wtf/stats/github, stey.me/stats/weathergpt
    return {
      basePath: `/stats/${key}`,
  ...
  return (
    <StatsContext.Provider
      value={{
        ...
        queryString,
        domain: domain || undefined, // domain for the link (e.g. u0.wtf, stey.me, etc.)
