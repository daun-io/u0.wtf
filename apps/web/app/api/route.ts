          ...
          parameters: [
            {
              name: "projectSlug",
              description:
                "The slug for the project to retrieve links for. E.g. for app.u0.wtf/acme, the projectSlug is 'acme'.",
              in: "query",
              required: true,
              schema: {
                description:
          ...
          parameters: [
            {
              name: "projectSlug",
              description:
                "The slug for the project to create links for. E.g. for app.u0.wtf/acme, the projectSlug is 'acme'.",
              in: "query",
              required: true,
              schema: {
                description:
          ...
          parameters: [
            {
              name: "projectSlug",
              description:
                "The slug for the project that the link belongs to. E.g. for app.u0.wtf/acme, the projectSlug is 'acme'.",
              in: "query",
              required: true,
              schema: {
                description:
            ...
            },
            {
              name: "domain",
              description:
                "The domain of the link to retrieve. E.g. for u0.wtf/github, the domain is 'u0.wtf'.",
              in: "query",
              required: true,
              schema: {
                description:
            ...
            },
            {
              name: "key",
              description:
                "The key of the link to retrieve. E.g. for u0.wtf/github, the key is 'github'.",
              in: "query",
              required: true,
              schema: {
                description:
          ...
          parameters: [
            {
              name: "projectSlug",
              description:
                "The slug for the project to retrieve. E.g. for app.u0.wtf/acme, the projectSlug is 'acme'.",
              in: "path",
              required: true,
              schema: {
                description:
          ...
          parameters: [
            {
              name: "projectSlug",
              description:
                "The slug for the project to retrieve tags for. E.g. for app.u0.wtf/acme, the projectSlug is 'acme'.",
              in: "path",
              required: true,
              schema: {
                description:
          ...
          parameters: [
            {
              name: "projectSlug",
              description:
                "The slug for the project to create tags for. E.g. for app.u0.wtf/acme, the projectSlug is 'acme'.",
              in: "path",
              required: true,
              schema: {
                description:
        ...
        LinkBody: {
          ...
          properties: {
            ...
            title: {
              type: "string",
              description:
                "The title of the short link generated via api.u0.wtf/metatags. Will be used for Custom Social Media Cards if `proxy` is true.",
              default: null,
              nullable: true,
            },
            description: {
              type: "string",
              description:
                "The description of the short link generated via api.u0.wtf/metatags. Will be used for Custom Social Media Cards if `proxy` is true.",
              default: null,
              nullable: true,
            },
            image: {
              type: "string",
              description:
                "The image of the short link generated via api.u0.wtf/metatags. Will be used for Custom Social Media Cards if `proxy` is true.",
              default: null,
              nullable: true,
            },
            rewrite: {
            ...
            geo: {
              type: "object",
              description:
                'Geo targeting information for the short link in JSON format {[COUNTRY]: "https://example.com" }. Learn more: https://u0.wtf/geo',
